...
const Banner = () => {
    ...
    return (
        <div>{bannerVisible && (
            <div className="bg-linear-to-r fromm-app-green via-emerald-800 to-app-green text-white text-xs sm:text-sm relative overflow-hidden">
...
text-yellow-400 shrink-0"/>
                        <span> Farm-fresh produce deliverd daily</span>
                    </div>
                </div>
