                    ...
                    <form onSubmit={handleSearch} className="hidden sm:flex flex-1 max-w-sm text-xs sm:text-sm">
                        <div className="relative w-full">
                            ...
                            <input
                                ...
                                className="w-full pl-8 bg-orange-50 rounded-full ring ring-app-orange/15 focus:ring-app-orange/30 outline-none py-2"
                            />
                        ...
                        <div className="relative">
                            {user ? (
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <Link
                                        to="/login"
                                        className="hidden md:flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-green-950 transition-colors"
                                    >
